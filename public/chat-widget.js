(function() {
  function init() {
    ...
    function addMsg(text, isUser, source) {
      if (!started) {
        started = true;
        hideSuggestions();
      }
    ...
    function ask() {
      ...
      .then(function(data) {
        ...
        if (data.error) {
          ...
          addMsg(data.answer, false, data.source);
        } else {
