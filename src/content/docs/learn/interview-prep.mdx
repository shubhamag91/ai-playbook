...
|-------|----------|-----------|
| [**LLM Engineering**](/learn/interview-prep-llm) | AI Engineer, Applied Scientist | Transformer internals, fine-tuning (LoRA/RLHF/DPO), RAG, evaluation, inference optimization |
| [**Quantitative Analytics in Banking**](/learn/interview-prep-quant-banking) | Quant Analyst, Model Risk, Data Scientist (Finance) | Credit risk, VaR, time series, SQL patterns, SR 11-7, fairness in lending |
| [**Machine Learning**](/learn/interview-prep-ml) | ML Engineer, Data Scientist | Classical algorithms, model evaluation, feature engineering, MLOps, system design |
