...
glossaryLinks:
  ...
  - prompt
tldr:
  - "Start with what an LLM is, then learn how it works in 4 hours"
  - "Includes hands-on experiments with real tools"
  - "Covers what AI can and cannot do to set realistic expectations"
...
<ProgressTracker
  pathId="beginner"
  sections={[
    { id: "s1", label: "What Is An LLM?", time: "30 min" },
    { id: "s2", label: "How Do They Work?", time: "1 hour" },
    { id: "s3", label: "What Can You Actually Do With Them?", time: "1 hour" },
    { id: "s4", label: "Your First Experiment", time: "1 hour" },
    { id: "s5", label: "What's Real vs Hype", time: "30 min" },
  ]}
/>
