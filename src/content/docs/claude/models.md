---
title: Claude Models
description: Deep comparison of Claude Opus 4.8 vs Claude Sonnet 4.6 vs Claude Haiku 4.5 — capabilities, benchmarks, pricing, context windows, extended thinking, adaptive thinking, and model selection guide.
sidebar:
  order: 2
tags:
  - claude
...
glossaryLinks:
  ...
  - fine-tuning
tldr:
  - "Three current model tiers: Opus 4.8 ($5/$25, 1M ctx), Sonnet 4.6 ($3/$15, 1M ctx), Haiku 4.5 ($1/$5, 200K ctx)"
  - "Opus 4.8 (May 2026) is the current flagship at $5/$25, 1M ctx — the 67% cut from Opus 4.1 ($15/$75) landed with Opus 4.7"
...
> **Pricing History:** Claude Opus 4.1 was $15/$75 per 1M. Opus 4.7 cut that **67%** to $5/$25 (with 1M context and step-change agentic coding); Opus 4.8 (May 2026) keeps the same pricing. Sonnet 4 dropped from current to deprecated. See [model deprecations](https://docs.anthropic.com/en/docs/about-claude/model-deprecations).

## Legacy & Deprecated Models

| Model | Status | API Price | Context | Migration Target |
|---|---|---|---|---|
| Claude Opus 4.7 | Legacy | $5/$25 | 1M | Opus 4.8 |
| Claude Opus 4.6 | Legacy | $5/$25 | 1M | Opus 4.8 |
| Claude Sonnet 4.5 | Legacy | $3/$15 | 200K | Sonnet 4.6 |
| Claude Opus 4.1 | Legacy | $15/$75 | 200K | Opus 4.8 |
| Claude Opus 4 | **Deprecated (June 15, 2026)** | $15/$75 | 200K | **Migrate to Opus 4.8** |
...
| **Adaptive Thinking** | Model autonomously decides when and how much to think. No budget to set — the model judges complexity. Less predictable cost. | Opus 4.8 (only) | Complex multi-step reasoning without manual tuning |
...
- Opus 4.8's Adaptive Thinking is the default — the model handles the judgment
...
What matters most?
│
├─ Maximum quality, complex reasoning → Claude Opus 4.8
...
│
└─ Maximum speed (premium) → Fast Mode (Opus 4.8)
...
| Scenario | Opus 4.8 | Sonnet 4.6 | Haiku 4.5 |
|---|---|---|---|
...
> **Tokenizer Note:** Claude Opus 4.8 uses a new tokenizer vs previous models. For identical text, Opus 4.8 may use up to **35% more tokens**. Factor this into cost comparisons — the lower per-token price partially offsets increased tokenization.
