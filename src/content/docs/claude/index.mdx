...
> **Note:** Opus pricing dropped 67% from Opus 4.1's $15/$75 to $5/$25 (with Opus 4.7); **Opus 4.8** (May 2026) is the current flagship at the same $5/$25 with 1M context and adaptive thinking. See [Claude Models](/claude/models) for detailed benchmarks and comparison.
