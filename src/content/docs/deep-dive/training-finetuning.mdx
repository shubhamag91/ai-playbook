...
:::important[When to Fine-Tune]
Do NOT fine-tune to teach facts — use RAG for that. Fine-tune for style, tone, and behavior. If you have fewer than 1000 examples, start with prompt engineering instead.
:::
