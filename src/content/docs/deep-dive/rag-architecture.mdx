...
<Playground
  title="RAG sandbox — grounded answering"
  defaultSystem={"Answer ONLY using the context below. If the answer isn't in the context, say \"I don't know based on the provided documents.\"\n\nContext:\n- Acme Cloud free tier: 1 project, 1 GB storage.\n- Pro plan: $20/month — unlimited projects, 50 GB, email support.\n- Enterprise: adds SSO and a dedicated SLA.\n- Refunds are processed within 5–7 business days."}
  defaultPrompt="How much is the Pro plan, and what extra do I get over the free tier?"
/>

:::important[Key Principle]
RAG quality is determined by retrieval quality. No amount of prompt engineering can fix bad retrieval. Invest in your embedding model, chunking strategy, and reranking before optimizing prompts.
:::
