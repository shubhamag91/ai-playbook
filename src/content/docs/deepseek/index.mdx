...
| **DeepSeek V4 Flash** | Cost-optimized with near-Pro quality | High-volume, cost-sensitive workloads | $0.14/$0.28 per 1M (cache hits: $0.0028) |
...
| **DeepSeek V4 Flash** | $0.14/$0.28 | $0.0028 | 1M tokens | High-volume, cost-sensitive, chat |
