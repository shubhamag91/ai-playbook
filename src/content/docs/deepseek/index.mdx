...
```mermaid
flowchart LR
    A["DeepSeek Models<br/>V4 Pro · V4 Flash · R1"] --> B["API Access<br/>OpenAI Format · Anthropic Format<br/>Thinking Mode · Tool Calls"]
    B --> C["Agent Integrations<br/>Claude Code · Copilot · OpenCode<br/>15+ coding agents"]
    A --> D["Open-Weight<br/>HuggingFace · Ollama<br/>MIT License"]
    B --> E["Chat<br/>chat.deepseek.com<br/>Free tier"]
```
