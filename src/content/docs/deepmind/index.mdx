...
glossaryLinks:
  ...
  - inference
tldr:
  - "DeepMind's ecosystem spans 15+ AI products: Gemini 3.5, Omni, Antigravity, Veo, Imagen, Lyria, Gemma, AlphaFold, and more"
  - "Core models: Gemini 3.5 (frontier intelligence), Gemini Omni (multimodal creation), Nano Banana 2 (image), Gemini Audio (voice)"
  - "Antigravity 2.0 is Google's agentic development platform. Google AI Studio is the free developer IDE"
  - "Gemma 4 is the open model family — multiple sizes, MIT-compatible license. Vertex AI for enterprise deployment"
...
```mermaid
flowchart LR
    A["Core Models\nGemini 3.5 · Omni · Nano Banana · Audio"] --> B["Development Platform\nAI Studio · Antigravity · Gemini API"]
...
|---|---|---|---|
| **Gemini 3.5** | Frontier intelligence model with action | Developers, enterprises | [aistudio.google.com](https://aistudio.google.com) |
| **Gemini Omni** | Natively multimodal — video, image, text, audio | Creators, developers | [gemini.google.com](https://gemini.google.com) |
| **Nano Banana 2** | Pro-level image generation and editing | Designers, creators | Gemini app, AI Studio |
| **Gemini Audio** | Real-time audio generation and processing | Voice/audio developers | AI Studio, Gemini Live API |
...
|---|---|---|
| **Gemini 3.5** | Frontier reasoning, agentic tasks, enterprise | Gemini API, AI Studio, Vertex AI |
| **Gemini Omni** | Native multimodal — video/audio/image/text | Gemini app, Google Flow |
| **Nano Banana 2** | Image generation and editing | Gemini app, AI Studio |
| **Gemini Audio** | Real-time voice and audio | Gemini Live API, AI Studio |
| **Gemma 4** | Open-source, self-hosted, on-device | Ollama, Hugging Face |
...
├─ Real-time voice/audio → Gemini Audio + Live API
├─ Create multimodal content → Gemini Omni + Google Flow
