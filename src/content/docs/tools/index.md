...
**Quick picks by task:**
- **Writing & analysis** → [Claude.ai](/decide/tools/guide/#conversational-ai) (best prose) or ChatGPT. For grammar: Grammarly.
- **Coding** → [Cursor](/decide/tools/guide/#code--build) (IDE) + Claude Code (complex). See the full coding tools comparison.
- **Research** → [Gemini](/decide/tools/guide/#conversational-ai) (1M context) or Perplexity (cited sources).
- **Images** → [Midjourney](/decide/tools/guide/#images) (quality) or DALL-E (in ChatGPT). Open-source: Flux.
- **Video** → [Runway](/decide/tools/guide/#video--audio) (editing + generation) or Sora.
- **Music & audio** → [Suno](/decide/tools/guide/#video--audio) (music) or ElevenLabs (voice).
- **Automation** → [Zapier](/decide/tools/guide/#automate--orchestrate) (easy) or n8n (self-hosted).
- **Web apps** → [Lovable](/decide/tools/guide/#code--build) (full-stack) or Vercel v0 (components).
- **Data analysis** → Claude Artifacts or [NotebookLM](/decide/tools/guide/#research--learning).
- **Knowledge & notes** → Obsidian + Claude or Notion AI.
- **Meetings** → Otter.ai (transcribe) or Fathom (recorder).
