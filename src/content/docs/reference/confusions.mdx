...
:::important[The Core Confusion]
An LLM does not understand, think, or reason in the human sense. It generates text that looks like it understands because it has seen similar patterns in training data. This is the single most important thing to understand about AI.
:::
