...
- Claude Haiku 4.5  -  Fastest, near-frontier ($1/$5 per 1M tokens, 200K context)
- Claude Sonnet 4.6  -  Balanced (default) ($3/$15 per 1M tokens, 1M context)
- Claude Opus 4.7  -  Most capable, agentic coding ($5/$25 per 1M tokens, 1M context)

Opus 4.7 and Sonnet 4.6 share 1M token context; Haiku 4.5 has 200K. Opus 4.7 dropped pricing 67% from previous generation ($15/$75 → $5/$25). See the [Claude section](/claude/) for complete ecosystem details.
...
**Model Tiers (cheapest → most capable):**
- Gemini 3.5 Flash  -  Fastest, most affordable (1M+ context, free tier on AI Studio)
- Gemini 3.5 Pro  -  Balanced, 1M+ context (most production workloads)
- Gemini 3.5 Ultra  -  Most capable (advanced reasoning, agentic capabilities)

Gemini 3.5 features frontier intelligence with action capabilities. Gemini Omni adds native multimodal (video, image, audio, text). All Gemini models benefit from DeepMind's research breakthroughs. See the [DeepMind section](/deepmind/) for complete ecosystem details.
