...
tldr:
  ...
  - "Llama 4, DeepSeek V4, and Muse Spark are the best open-weight models"
  - "Self-hosting breaks even at 50M+ tokens per month"
...
| **Llama 4 Scout** | MIT | 109B | 10M context, MoE efficiency | Ollama, vLLM |
| **Qwen 3.6** | Custom | 72B | Strong reasoning, multilingual, vision | Ollama, Hugging Face |
...
| **Muse Spark** | MIT | 70B+ | Meta's latest, strong design capabilities | Ollama, local GPU |
