...
<CardGrid>
  ...
  <Card title="Gemini" icon="open-book">
    Google's multimodal AI — Gemini 3.1 Pro offers a 1M-token context window (largest among major models). Deeply integrated with Google Workspace.
    <Badge text="Freemium" variant="note" />
  </Card>
...
<CardGrid>
  ...
  <Card title="Claude Code" icon="terminal">
    Anthropic's agentic coding CLI — edits files, runs tests, opens PRs from your terminal. Included with Claude Pro ($20/mo) or pay-per-use via API.
    <Badge text="Paid" variant="danger" />
  </Card>
  ...
  <Card title="Lovable" icon="rocket">
    Build and deploy full-stack React apps from natural language — generates backend, frontend, and hosting. No coding required. Best for MVPs and complete apps.
    <Badge text="Freemium" variant="note" />
  </Card>
  <Card title="Vercel v0" icon="open-book">
    Generate shadcn/Tailwind UI components from text — produces copy-paste code you integrate into your existing project. Best for UI design, not full apps.
    <Badge text="Freemium" variant="note" />
  </Card>
</CardGrid>

**Pro tip:** Cursor and Claude Code are complementary — use Cursor for your daily IDE work and Claude Code for complex refactors, CLI automation, and batch operations. Many developers use both.
...
<CardGrid>
  ...
  <Card title="Stable Diffusion / Flux" icon="seti:image">
    Open-source image models you can run locally or via APIs. Flux (Black Forest Labs) also has a paid API — $0.05/image for standard generation, $0.10/image for ultra quality. Massive community.
    <Badge text="Open Source" variant="tip" />
    <Badge text="API Available" variant="note" />
  </Card>
