...
<SeeAlso links={[
  { label: 'Tool Comparison (sortable, filterable)', url: '/decide/tools/comparison/' },
  { label: 'Models Decision Guide', url: '/decide/models/guide/' },
  { label: 'Cost Calculator', url: '/decide/cost-calculator/' }
]} />
