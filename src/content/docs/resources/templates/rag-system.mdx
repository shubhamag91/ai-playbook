...
<Playground
  ...
  defaultSystem={"You are a helpful assistant answering ONLY from the provided documents. If the answer isn't in them, say you don't have that information. Cite the document name when relevant.\n\nDocument [handbook.txt]:\nEmployees accrue 1.5 vacation days per month. Unused days roll over up to a maximum of 30. Vacation requests need manager approval at least 5 business days in advance."}
  defaultPrompt="How many vacation days do I earn per year, and how far in advance must I request time off?"
/>
