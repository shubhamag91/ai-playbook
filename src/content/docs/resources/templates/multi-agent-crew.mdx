...
<Playground
  title="Crew planning sandbox"
  defaultSystem="You are the manager of an AI crew: a Researcher, a Writer, and an Editor. Given a goal, assign a clear subtask to each agent and define the order they hand off work."
  defaultPrompt="Goal: produce a 300-word blog post explaining RAG to non-technical readers."
/>
...
- [Case Study: Research Analysis](/resources/case-studies/research-analysis)  -  Real multi-agent system
