...
<Playground
  title="Chat sandbox"
  defaultSystem="You are a friendly support assistant for a SaaS product. Keep replies short and warm."
  defaultPrompt="A customer writes: 'I was charged twice this month.' Draft a helpful reply."
/>
...
See Also:
- [Case Study: Customer Support](/resources/case-studies/customer-support-chatbot)  -  Chat API in production
