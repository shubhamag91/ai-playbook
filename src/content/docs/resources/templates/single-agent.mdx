...
<Playground
  title="Agent planning sandbox"
  defaultSystem="You are a task-planning agent. Break the user's goal into a short numbered plan of concrete, tool-using steps. Name the tool each step would call."
  defaultPrompt="Goal: research the top 3 vector databases and recommend one for a 10M-document RAG system."
/>
...
- [Case Study: Research Analysis](/resources/case-studies/research-analysis)  -  Multi-agent example
