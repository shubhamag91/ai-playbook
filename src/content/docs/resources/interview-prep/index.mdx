...
|-------|----------|-----------|
| [**LLM Engineering**](/resources/interview-prep/llm) | AI Engineer, Applied Scientist | Transformer internals, fine-tuning (LoRA/RLHF/DPO), RAG, evaluation, inference optimization |
| [**Quantitative Analytics in Banking**](/resources/interview-prep/quant-banking) | Quant Analyst, Model Risk, Data Scientist (Finance) | Credit risk, VaR, time series, SQL patterns, SR 11-7, fairness in lending |
| [**Machine Learning**](/resources/interview-prep/ml) | ML Engineer, Data Scientist | Classical algorithms, model evaluation, feature engineering, MLOps, system design |
| [**AI Data Scientist**](/resources/interview-prep/ai-data-scientist) | AI Data Scientist, Applied Data Scientist | Statistics, experimentation, LLM application, causal inference, SQL, business impact |

---

<ProgressTracker
  pathId="interview-prep"
  sections={[
    { id: "w1d1", label: "Week 1  -  Day 1: LLM Architecture & Training", time: "2-3 hours" },
    { id: "w1d2", label: "Week 1  -  Day 2: Prompt Engineering & RAG", time: "2-3 hours" },
    { id: "w1d3", label: "Week 1  -  Day 3: Agents & Tools", time: "2-3 hours" },
    { id: "w1d4", label: "Week 1  -  Day 4: System Design", time: "2-3 hours" },
    { id: "w1d5", label: "Week 1  -  Day 5: Product Strategy", time: "2-3 hours" },
    { id: "w2d1", label: "Week 2  -  Day 1: Behavioral Stories", time: "2-3 hours" },
    { id: "w2d2", label: "Week 2  -  Day 2: Mock Interviews", time: "2-3 hours" },
    { id: "w2d3", label: "Week 2  -  Day 3: Weak Areas Review", time: "2-3 hours" },
    { id: "w2d4", label: "Week 2  -  Day 4: Final Review", time: "2-3 hours" },
    { id: "w2d5", label: "Week 2  -  Day 5: Rest & Prep", time: "1 hour" },
  ]}
/>
