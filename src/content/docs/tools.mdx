...
<CardGrid>
  <Card title="LangSmith" icon="seti:cpu">
    LangChain's observability and evaluation platform for LLM apps. Debug, test, monitor.
    <Badge text="Freemium" variant="note" />
  </Card>
  <Card title="OpenTelemetry" icon="seti:cpu">
    Open standard for LLM tracing and observability. Vendor-agnostic instrumentation.
    <Badge text="Open Source" variant="tip" />
  </Card>
  <Card title="LangFuse" icon="seti:cpu">
    Open-source LLM engineering platform — traces, evals, prompts, cost tracking.
    <Badge text="Open Source" variant="tip" />
    <Badge text="Freemium" variant="note" />
  </Card>
  <Card title="Helicone" icon="seti:cpu">
    Open-source observability for OpenAI. Proxy-based tracing, easy setup.
    <Badge text="Open Source" variant="tip" />
  </Card>
</CardGrid>
