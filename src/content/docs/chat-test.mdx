...
<link rel="stylesheet" href="/chat/css/ChatWidget.css" />
  ...
  <div class="cw-panel" id="cw-panel">
    ...
    <div class="cw-messages" id="cw-messages">
      <div class="cw-msg cw-bot">
        <div class="cw-msg-content">Ask me anything.</div>
      </div>
    </div>
...
This is a test page for the chat widget. If you see the button and it's clickable, the widget works.
