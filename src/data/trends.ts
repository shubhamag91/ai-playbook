...
export const trendingTopics: TrendItem[] = [
  {
    ...
    description: '400K context, agent mode by default, $15/$75 per 1M tokens — Anthropic\'s new flagship.',
  ...
  },
  {
    ...
    description: 'OpenAI\'s fastest model yet — <1s responses, $0.05/$0.15 per 1M tokens, ideal for real-time apps.',
  ...
  {
    title: 'Nvidia Blackwell Inference Speed',
    description: 'Nvidia\'s dedicated inference hardware hits 2000+ tok/s on Llama 3 70B — challenging Groq\'s lead.',
  ...
  },
  {
    ...
    description: 'Meta\'s largest open model. MoE architecture, 405B total parameters, 16 experts. MIT license.',
    link: '/research/whats-new',
    date: 'Feb 2026',
    category: 'Open Source',
  },
