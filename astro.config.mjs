        ...
        },
        {
          ...
          items: [
            ...
            { label: 'Tools & Frameworks', slug: 'resources/tools-frameworks' },
            {
              ...
              collapsed: true,
              items: [
                { label: 'Overview & 2-Week Plan', slug: 'resources/interview-prep' },
                { label: 'LLM Engineering', slug: 'resources/interview-prep/llm' },
                { label: 'Quantitative Analytics', slug: 'resources/interview-prep/quant-banking' },
                { label: 'Machine Learning', slug: 'resources/interview-prep/ml' },
