          ...
          items: [
            ...
            { label: 'Workflows', slug: 'learn/workflows' },
            {
              ...
              items: [
                ...
                { label: 'System Design', slug: 'learn/interview-prep-system-design' },
                { label: 'Behavioral', slug: 'learn/interview-prep-behavioral' },
                { label: 'AI Product', slug: 'learn/interview-prep-product' },
              ],
            },
